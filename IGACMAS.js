...
if(window.location.href.indexOf(urlBase) > -1) {
  ...
  var arrayLength = codDep.length;
  for (var i = 0; i < arrayLength; i++) {
      var cod = codDep[i]+codMun[i]+codTA[i]+codSE[i]+codMAVE[i]+codPRED[i]+codMEJ[i];
    
    myObject2['formBusqueda3:j_id43']= codDep[i];
    myObject2['formBusqueda3:j_id47']= codMun[i];
    myObject2['formBusqueda3:j_id129']= codDep[i];
    myObject2['formBusqueda3:j_id130']= codMun[i];
    myObject2['formBusqueda3:j_id131']= codTA[i];
    myObject2['formBusqueda3:j_id132']= codSE[i];
    myObject2['formBusqueda3:j_id133']= codMAVE[i];
    myObject2['formBusqueda3:j_id134']= codPRED[i];
    myObject2['formBusqueda3:j_id135']= codMEJ[i];
